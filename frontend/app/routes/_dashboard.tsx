...
const Icons = {
    ...
    Certificates: () => (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M15 12h-5" /><path d="M15 16h-5" /><path d="M16 6H8a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2Z" /><path d="M12 2v4" /><path d="M12 2a2 2 0 0 0-2 2" /><path d="M12 2a2 2 0 0 1 2 2" /></svg>
    ),
    Search: () => (
...
export default function DashboardLayout() {
    ...
    const SidebarContent = () => (
        <div className="h-full flex flex-col bg-base-100 transition-all duration-300">
            ...
            {/* Navigation Nodes */}
            <nav className="flex-1 px-4 py-4 space-y-2 overflow-y-auto custom-scrollbar" aria-label="Sidebar Navigation">
                {navLinks.map((link) => (
                    <NavLink
                        key={link.to}
                        to={link.to}
            ...
            <div className="hidden lg:block p-4 border-t border-base-content/5">
                ...
                >
                    <span className={`transition-transform duration-500 inline-block ${!isSidebarOpen ? 'rotate-180' : ''}`}>
                        <Icons.ChevronLeft />
                    </span>
                    {isSidebarOpen && (
